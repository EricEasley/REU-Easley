	...
	if(!strcmp(itype, "CHW")){
		...
		omap = (float***) malloc(sizeof(float**) * oc);
                ...
                for(i = 0; i < oc; i++){
                        ...
                        for(j = 0; j < o1; j++){
                                omap[i][j] = (float*) calloc(o2, sizeof(float));
                        }
                }
		...
		omap = (float***) malloc(sizeof(float**) * o1);
                ...
                for(i = 0; i < o1; i++){
                        ...
                        for(j = 0; j < o2; j++){
                                omap[i][j] = (float*) calloc(oc, sizeof(float));
                        }
                }
...
//		        	        	omap[ic*kcnls + kc][i][j] = 0;
		                	        	for(x = 0; x < kh; x++){
		                        	        	for(y = 0; y < kw; y++){
		                                	        	omap[kc][i][j] += imap[ic][i*stride + x][j*stride + y] * kernel[kc][x][y];
								}
		                                	}
		                        	}
		                	}
  ...
  //      	                                omap[i][j][ic*kcnls + kc] = 0;
                	                                for(x = 0; x < kh; x++){
                        	                                for(y = 0; y < kw; y++){
                                	                                omap[i][j][kc] += imap[i*stride + x][j*stride + y][ic] * kernel[x][y][kc];
								}
                                                        }
                                                }
                                        }
